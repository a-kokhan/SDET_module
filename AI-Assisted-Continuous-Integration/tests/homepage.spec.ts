...
test.describe('HomePage Tests', () => {
  ...
  test('should verify page loads successfully', async () => {
    // Web-first assertion - auto-waits for condition
    const isLoaded = await homePage.isPageLoaded();
    expect(isLoaded).toBeTruthy();
  });

  test('should display correct main heading text', async () => {
  ...
  test('should verify main heading is visible', async () => {
    // Auto-waiting assertion
    await expect(homePage.mainHeading).toBeVisible();
  });

  test('should verify description text is present', async () => {
  ...
  test('should verify learn more link is clickable', async () => {
  ...
  test('should navigate to learn more when link clicked', async ({ page }) => {
